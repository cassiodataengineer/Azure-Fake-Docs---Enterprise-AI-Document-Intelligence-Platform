...
Para uma visão aprofundada sobre as decisões de design, diagramas e detalhes de implementação, consulte a [Documentação Técnica] (https://github.com/cassiodataengineer/Azure-Fake-Docs---Enterprise-AI-Document-Intelligence-Platform/blob/main/ARCHITECTURE.md) 
